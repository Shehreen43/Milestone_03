  ...
  return (
    <header className="flex flex-wrap justify-between items-center px-4 py-2">
      ...
      <div className="flex w-full flex-wrap justify-between items-center">
        ...
        {/* User actions */}
        <div className="flex items-center gap-x-4 sm:mt-0 flex-1 sm:flex-none">
          {/* Basket */}
          <Link
            href="/basket"
          ...
          <ClerkLoaded>
            ...
            {user?.passkeys.length === 0 && (
              <button
                ...
                className="bg-white hover:bg-blue-500 hover:text-white animate-pulse text-blue-500 font-bold py-2 px-4 rounded border-blue-300 border"
              >
                Create passkey
              </button>
            )}
